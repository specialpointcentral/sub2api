<template>
  <div ref="rootRef" v-if="showUsageWindows">
    ...
    <template v-else-if="isKiroOAuth">
      <div v-if="loading" class="space-y-1.5">
...
const showUsageWindows = computed(() => {
  ...
  return props.account.type === 'oauth' || props.account.type === 'setup-token' || props.account.type === 'kiro'
})
...
const isKiroOAuth = computed(() => {
  return props.account.platform === 'anthropic' && props.account.type === 'kiro'
})
