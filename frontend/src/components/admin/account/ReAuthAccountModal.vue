...
const isKiro = computed(() => props.account?.platform === 'anthropic' && props.account?.type === 'kiro')
const isAnthropic = computed(() => props.account?.platform === 'anthropic' && !isKiro.value)
const isAntigravity = computed(() => props.account?.platform === 'antigravity')
const isGrok = computed(() => props.account?.platform === 'grok')

const oauthPlatform = computed<OAuthFlowPlatform>(() => {
...
const isManualInputMethod = computed(() => {
  // OpenAI/Gemini/Antigravity/Grok/Kiro always use manual input (no cookie auth option)
