...
func TestGetOIDCEndpointFallsBackForInvalidRegion(t *testing.T) {
	got := getOIDCEndpoint("us-east-1.example.com")
	want := "https://oidc.us-east-1.amazonaws.com"
	if got != want {
		t.Fatalf("getOIDCEndpoint(invalid region) = %q, want %q", got, want)
	}
}
