...
var DefaultModels = []Model{
	...
	{ID: "claude-sonnet-4-5-thinking", Type: "model", DisplayName: "Claude Sonnet 4.5 (Thinking)"},
	...
	{ID: "claude-haiku-4-5-thinking", Type: "model", DisplayName: "Claude Haiku 4.5 (Thinking)"},
