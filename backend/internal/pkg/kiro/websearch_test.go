...
func TestBuildMcpEndpointFallsBackForInvalidRegion(t *testing.T) {
	require.Equal(t, "https://q.us-east-1.amazonaws.com/mcp", BuildMcpEndpoint("us-east-1.example.com"))
}
