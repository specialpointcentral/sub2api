...
func (c *gatewayCache) SaveLiveCall(ctx context.Context, record *service.LiveCallRecord, ttl time.Duration) error {
	...
	values := map[string]any{
		...
		"model_rate_limit_effective_model": record.ModelRateLimitEffectiveModel,
		"model_rate_limit_request_id":      record.ModelRateLimitRequestID,
		"model":                            record.Model,
...
func (c *gatewayCache) GetLiveCall(ctx context.Context, callHash string) (*service.LiveCallRecord, error) {
	...
	return &service.LiveCallRecord{
		...
		ModelRateLimitEffectiveModel: values["model_rate_limit_effective_model"],
		ModelRateLimitRequestID:      values["model_rate_limit_request_id"],
		Model:                        values["model"],
		CreatedAt:                    createdAt,
		ExpiresAt:                    expiresAt,
