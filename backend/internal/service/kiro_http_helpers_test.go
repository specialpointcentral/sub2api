...
func TestBuildKiroMachineIDForKiroTypeIgnoresLegacyAPIKeyCredential(t *testing.T) {
	account := &Account{
		ID:       103,
		Platform: PlatformAnthropic,
		Type:     AccountTypeKiro,
	...
	require.Equal(t, kiropkg.BuildMachineID("", "", "account:103"), buildKiroMachineID(account))
}
