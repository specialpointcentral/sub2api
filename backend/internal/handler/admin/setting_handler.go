...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAICodexDevicePoolSize:                              settings.OpenAICodexDevicePoolSize,
		OpenAICodexDevicePoolPlatformRatio:                     settings.OpenAICodexDevicePoolPlatformRatio,
		OpenAICodexUAPersonaEnabled:                            settings.OpenAICodexUAPersonaEnabled,
		OpenAICodexVersionStaggerMaxHours:                      settings.OpenAICodexVersionStaggerMaxHours,
		OpenAIRequestPacingEnabled:                             settings.OpenAIRequestPacingEnabled,
		OpenAIRequestPacingMinIntervalMS:                       settings.OpenAIRequestPacingMinIntervalMS,
		OpenAIRequestPacingMaxIntervalMS:                       settings.OpenAIRequestPacingMaxIntervalMS,
		OpenAIAccountThreadConcurrencyLimit:                    settings.OpenAIAccountThreadConcurrencyLimit,
		OpenAIQuotaProbeIntervalMinutes:                        settings.OpenAIQuotaProbeIntervalMinutes,
		OpenAIQuotaProbeJitterRatio:                            settings.OpenAIQuotaProbeJitterRatio,
