...
func TestAccountFromServiceShallow_ExpiredWeeklyQuotaDisplaysZeroUsed(t *testing.T) {
	account := &service.Account{
		Status:      service.StatusActive,
		Schedulable: true,
		Type:        service.AccountTypeAPIKey,
	...
	require.NotNil(t, out.QuotaWeeklyUsed)
	require.Zero(t, *out.QuotaWeeklyUsed)
}
