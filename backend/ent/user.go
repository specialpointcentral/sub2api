...
type UserEdges struct {
	...
	// ModelRateLimitRules holds the value of the model_rate_limit_rules edge.
	ModelRateLimitRules []*ModelRateLimitRule `json:"model_rate_limit_rules,omitempty"`
...
// ModelRateLimitRulesOrErr returns the ModelRateLimitRules value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) ModelRateLimitRulesOrErr() ([]*ModelRateLimitRule, error) {
	if e.loadedTypes[13] {
		return e.ModelRateLimitRules, nil
	}
	return nil, &NotLoadedError{edge: "model_rate_limit_rules"}
}
...
// QueryModelRateLimitRules queries the "model_rate_limit_rules" edge of the User entity.
func (_m *User) QueryModelRateLimitRules() *ModelRateLimitRuleQuery {
	return NewUserClient(_m.config).QueryModelRateLimitRules(_m)
}
