...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/specialpointcentral/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="specialpointcentral/sub2api"
...
Documentation=https://github.com/specialpointcentral/sub2api
